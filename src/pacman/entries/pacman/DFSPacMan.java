...
/*
 * Using Depth-first search to implement Ms PacMan.
 */
...
public class DFSPacMan extends Controller<MOVE> {
    ...
    public MOVE getMove(Game game, long timeDue) {
        ...
        //If the list is not empty, poll out the first one. Find its child and save them in the list.
        while (!list.isEmpty() && list.peekFirst().depth<= limit) {
            Node target = list.pollFirst();
